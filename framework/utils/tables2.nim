# Custom implementation of the original tables implementation with a small
# change: It allows to define a custom initTable through exporting TTable's
# data and counter properties
############################################################################
#
#
